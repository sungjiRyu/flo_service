package com.greenart.flo.controller;
...
import com.greenart.flo.service.AdminService;
import com.greenart.flo.vo.AdminAddVO;
import com.greenart.flo.vo.AdminInfoVO;
import com.greenart.flo.vo.AdminLoginVO;
import com.greenart.flo.vo.AdminUpdateVO;
...
public class AdminController {
    ...
    public String getAdminList(Model model, @RequestParam @Nullable String keyword, 
        ...
        else if (admin.getAdmin_grade()!=99) { // 로그인 상태이지만 마스터가 아니라면
            return "redirect:/main"; // 메인페이지로
        }
        // size : 한 페이지 당 출력 할 row 수
        // sort : 정렬 기준이 될 엔터티 변수 명
        // direction : 정렬 방향(오름차순(default), 내림차순)
    ...
    public String getAdminUpdateStatus(
        @RequestParam Integer value, @RequestParam Long admin_no, @RequestParam Integer page, @RequestParam @Nullable String keyword
    ) {
