document.addEventListener("DOMContentLoaded", function(){
    ...
    elemId("genre_add_close").addEventListener("click", function() {
        ...
        elemId("genre_add_wrap").style.display=""; // 입력창의 display 를 기존상태로 돌린다.
        elemId("add_err_msg").innerHTML = "";
    })
    ...
    elemId("genre_update_close").addEventListener("click", function() {
        ...
        elemId("genre_update_wrap").style.display=""; // 입력창의 display 를 기존상태로 돌린다.
...
function loadpubList(page, keyword) {
